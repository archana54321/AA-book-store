	...
	<div className="relative py-3 sm:max-w-xl sm:mx-auto">
		...
		<div className="relative px-4 py-10 bg-white shadow-lg sm:rounded-3xl sm:p-20">
          ...
          {/* <div className="relative">
							<input  id="username" name="username" type="username" className="peer  h-10 w-full border-b-2 border-gray-300 text-gray-900 focus:outline-none focus:borer-rose-600" placeholder="Username" />
            ...
            {/* <div className="relative">
						...
						<div className="relative">
							<button className="bg-blue-500 text-white rounded-md px-6x py-2">Register</button>
						</div>
					</form>
				</div>
			</div>
